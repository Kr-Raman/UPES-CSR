            ...
            <div className="footer">
                <div className="menus">
                    ...
                    <div className="col">
                        ...
                        <ul className="list quick_links">
                            <li>Call us at: +91 9999999999</li>
                            <li>Write to us: <a className="email_link" href="mailto:upes.ac.in">upes.ac.in</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="col">
                        ...
                        <a href="https://api.whatsapp.com/send?phone=+919999999999" rel="noopener noreferrer" target="_blank">
                ...
                <p>designed with ❤ by raman and raghav</p>
                </div>
